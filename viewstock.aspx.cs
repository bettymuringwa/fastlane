        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {  //very important to prevent controls reloading and resetting values already selected
                    String sql = @"SELECT  * from StockEntry where categoryID = 'GR'
                                     ;";
                ...
                if (!IsPostBack)
                {  //very important to prevent controls reloading and resetting values already selected
                    String sql = @"SELECT * from StockEntry where categoryID = 'FN'
                                    ;";
                ...
                if (!IsPostBack)
                {  //very important to prevent controls reloading and resetting values already selected
                    String sql = @"SELECT * from StockEntry where categoryID = 'CL'
                                    ;";
                ...
                if (!IsPostBack)
                {  //very important to prevent controls reloading and resetting values already selected
                    String sql = @"SELECT * from StockEntry where categoryID = 'EL'
                                    ;";

<%@ Page Title="" Language="C#" MasterPageFile="~/homeMaster.Master" AutoEventWireup="true" CodeBehind="managecustomers.aspx.cs" Inherits="abc20025_fastlane.managecustomers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <fieldset id="fldsetcontrols" class="clsfieldset">
        ...
        <div id="divcontrols">
            ...
            <input runat="server"  ClientIDMode="Static" type="text" id="bankname" name="bankname" placeholder="Bank Name" oninvalid="setCustomValidity('Please enter the user cell number !!')" oninput="setCustomValidity('')" />
            <br />

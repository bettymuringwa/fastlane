    ...
    public partial class stafflog : System.Web.UI.Page
    {
        ...
        protected void btnlogin_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string sql = $@"select * from Staff where email = '{username.Value}' and staffPassword = '{password.Value}' ";
                ...
                else
                {
                    ...
                    string usergroup = (ds.Tables["data"].Rows[0]["groupid"].ToString().ToUpper() == "AD") ? "Admin" : "Staff";
                   ...
                   // string surname = ds.Tables["data"].Rows[0]["surname"].ToString();
                    ...
                    string fullname = $" {firstname} - [{usergroup.ToUpper()}]";
